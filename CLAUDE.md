...
Configuration problems surface as `[Configuration Error] …` and stop the loop. Network or API failures print `[Request Error] …` and the loop continues so you can try again.
